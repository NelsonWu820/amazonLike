                    ...
                    <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        <div className="col mb-5">
                            <div className="card h-100">
                                ...
                                <img className="card-img-top item_1_img" src= {item_1} alt="..." />
                    
                                <div className="card-body p-4">
                                    <div className="text-center">
                            
                                        <h5 className="fw-bolder">BikeTireDirect BackPack</h5>
                        ...
                        <div className="col mb-5">
                            <div className="card h-100">
                                ...
                                <img className="card-img-top" src={item_2} alt="..." />
                    
                                <div className="card-body p-4">
                                    <div className="text-center">
                            
                                        <h5 className="fw-bolder">Razor Mouse</h5>
                        ...
                        <div className="col mb-5">
                            <div className="card h-100">
                                ...
                                <img className="card-img-top" src={item_3} alt="..." />
                    
                                <div className="card-body p-4">
                                    <div className="text-center">
                            
                                        <h5 className="fw-bolder">Sony Headphones</h5>
                        ...
                        <div className="col mb-5">
                            <div className="card h-100">
                                ...
                                <img className="card-img-top" src={item_4} alt="..." />
                    
                                <div className="card-body p-4">
                                    <div className="text-center">
                            
                                        <h5 className="fw-bolder">ZWILLING Stainless Steel Knife Set</h5>
